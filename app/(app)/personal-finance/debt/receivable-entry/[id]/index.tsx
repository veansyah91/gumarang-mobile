...
export default function DebtReceivableEntryDetailPage() {
  ...
  if (isLoading) {
    return (
      <>
        <FixedAssetSubHeader title="Detail Entry Piutang" />
        ...
        <View style={styles.container}>
          ...
          <View style={styles.actionButtons}>
            <Button
              ...
              label="Edit"
              onPress={() =>
                router.push(pfRoutes.receivableEntryEdit(entryId, debtId))
              }
            />
            <Button
              variant="danger"
