...
function renderEntryItem(
  ...
  return (
    <Pressable
      key={item.id}
      onPress={() =>
        router.push(pfRoutes.receivableEntryDetail(item.id, item.debt_id))
      }
      style={({ pressed }) => ({
...
export default function DebtReceivableEntryListPage() {
  ...
  return (
    <>
      <PersonalFinanceListScreen
        ...
        emptyTitle="Belum ada pembayaran piutang"
        ...
        mainFab={
          <ListFab
            onPress={() => router.push(pfRoutes.receivableEntryCreate())}
          />
        }
      />
