...
export default function DebtReceivableEntryPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (amount <= 0) {
      showToast('Masukkan jumlah pelunasan', 'danger');
      return;
    }
    if (!accountId) {
