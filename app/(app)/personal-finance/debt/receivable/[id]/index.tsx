...
export default function DebtReceivableDetailPage() {
  ...
  if (isLoading) {
    return (
      <>
        <FixedAssetSubHeader title="Detail Piutang" />
        ...
        <View style={styles.container}>
          ...
          {debt.status === 'pending' && (
            <View style={styles.actionButtons}>
              <Button
                ...
                label="Edit"
                onPress={() =>
                  router.push(pfRoutes.receivableEdit(debtId))
                }
              />
              <Button
                variant="danger"
          ...
          <View style={styles.payActionContainer}>
            <Button
              ...
              onPress={() =>
                router.push(
                  pfRoutes.receivableEntryCreateWithDebt(debtId, debt.balance),
                )
              }
            />
          </View>
