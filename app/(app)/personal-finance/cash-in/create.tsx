...
import { useCashInNewRef, useCreateCashIn } from '@/src/hooks/use-cash-in';
...
export default function CashInCreatePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showToast('Kas Masuk berhasil ditambahkan', 'success');
      router.back();
    } catch (err) {
  ...
  return (
    <>
      <FixedAssetSubHeader title="Tambah Kas Masuk" />
