...
import { useCashOutNewRef, useCreateCashOut } from '@/src/hooks/use-cash-out';
...
export default function CashOutCreatePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showToast('Kas Keluar berhasil ditambahkan', 'success');
      router.back();
    } catch (err) {
  ...
  return (
    <>
      <FixedAssetSubHeader title="Tambah Kas Keluar" />
        ...
        <View style={formStyles.formContainer}>
          ...
          <View style={formStyles.submitContainer}>
            <Button
              ...
              disabled={isSubmitting || isRefLoading}
            />
          </View>
        </View>
      </Screen>
