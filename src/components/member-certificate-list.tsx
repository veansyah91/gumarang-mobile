...
function CertificateListLoadingState() {
  return (
    ...
    >
      <View style={styles.modalBackdrop}>
        ...
        <View style={[styles.modalCard, { backgroundColor: colors.surface }]}>
          ...
          <Text tone="muted">Gunakan format YYYY-MM-DD.</Text>
          ...
          <Text tone="muted" style={styles.helperText}>
            Tombol simpan akan aktif jika kedua tanggal valid dan end date tidak
            lebih kecil dari start date.
          </Text>
      ...
      {query.isLoading && !data ? (
        ...
        <View style={styles.section}>
          <Subnav
            ...
            onNext={() =>
              setPage((current) =>
                Math.min(paginationInfo.lastPage, current + 1),
              )
            }
          />

          <View style={styles.listSection}>
            <Text variant="subtitle">Daftar Sertifikat</Text>
